...
plt.legend()
plt.text(popt[0]**2/popt[1]**2,elec(popt[0]**2/popt[1]**2,popt[0])/10,str(np.round(popt[0]**2/popt[1]**2, decimals=2)))
plt.text(popt[1]**2/popt[2]**2,popt[2]**2/10,str(np.round(popt[1]**2/popt[2]**2, decimals=2)))
plt.savefig('plot.png')
print('Intersect quantum noise and electronic noise: '+str(np.round(popt[0]**2/popt[1]**2, decimals=2))+' uGy')
print('Intersect quantum noise and structure noise: '+str(np.round(popt[1]**2/popt[2]**2, decimals=2))+ ' uGy')